...
import MisAsociacionesR from "../../Views/Asociaciones/MisAsociaciones";
...
import AsociarseEvento from "@/Views/Asociaciones/AsociarseEvento";
...
const MisAsociacionesRStack = () => {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen name="AsociarseEvento" component={AsociarseEvento} />
